    ...
    return (
        <section ref={ref} id="home" className="hero-background text-center text-white py-24 md:py-32">
            <div className="max-w-7xl mx-auto px-4">
                ...
                <button 
                    onClick={onDemoClick}
                    className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full text-lg transition-all duration-300 transform hover:scale-105 shadow-lg cursor-pointer"
                >
